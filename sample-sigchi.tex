...
Often mostly all data-intensive tasks require large data sets moving between computers in order to operate correctly. Moving data repeatedly to distant nodes is becoming the bottleneck [23]. 
